...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="prh-content-right">
    ...
    <div class="field field-name-field-on-sale-date field-type-text field-label-inline clearfix prh-on-sale-date">
    ...
    <div class="field field-name-body field-type-text-with-summary field-label-above prh-descriptoin">
      <div class="field-label">Description:&nbsp;</div>
      <div class="field-items"><?php print $decoded_body; ?></div>
    </div>
